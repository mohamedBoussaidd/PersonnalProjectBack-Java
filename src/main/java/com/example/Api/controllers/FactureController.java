...
public class FactureController {
    ...
    public ResponseEntity<?> creeFacture(@Valid @RequestBody FactureRequest facture,
        ...
        /*
         * on parcour les produit de la factureRequest qu'on a en paramettre et pour
         * chaque element on cree un produit pour le remplire avec les bonnes
         * information du produit et on ajoute le produit a la liste de produit a chaque
         * fois
         */
        ...
        /*
         * on va chercher en bdd un client qui correspond au nom que l'on a dans la
         * facrureRequest
         */
        ...
        factur.setNCommande(facture.getNumeroCommande());

        /*
         * on redirige vers le service de facture avec la facture reconstruite la liste
         * de produit et l'id de l'entreprise
         */
